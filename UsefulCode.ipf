...
do
	...
	redimension /N=(typecount+1) types, avgw, semw
...
killvariables V_npnts,V_numNaNs,V_numINFs,V_avg,V_sdev,V_sem,V_rms,V_minloc,V_min,V_maxloc,V_max,V_adev,V_skew,V_kurt
killvariables V_minChunkLoc,V_maxChunkLoc,V_minLayerLoc,V_maxLayerLoc,V_maxRowLoc,V_minRowLoc,V_maxColLoc
killvariables V_minColLoc,V_startRow,V_endRow,V_startCol,V_endCol,V_Sum,V_startLayer,V_startChunk,V_endLayer,V_endChunk
end
